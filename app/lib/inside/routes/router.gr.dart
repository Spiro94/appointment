...
/// generated route for
/// [AppointmentCapture_Page]
class AppointmentCapture_Route extends PageRouteInfo<void> {
  const AppointmentCapture_Route({List<PageRouteInfo>? children})
    : super(AppointmentCapture_Route.name, initialChildren: children);

  static const String name = 'AppointmentCapture_Route';
