...
If you just created a project from the [appointment](https://github.com/gadfly361/appointment), then you still have a few manual things to do before the project is ready.
